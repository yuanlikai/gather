...
<template>
  <div class="content">
    <Card style="border:none;margin: 16px 0;">
      <div class="ivu-page-header-title">分类管理</div>
    </Card>
    <Content :style="{margin: '0 20px 20px 20px', background: '#fff',padding: '16px','min-height':'400px'}">
